    ...
    <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-5 font-PJSregular text-sm text-secondary border rounded-xl mt-5">
          ...
          <p className="text-left border-r border-b p-1 px-2">Payment ID</p>
          ...
          <p></p>
          <p></p>
          <p className="p-4 text-primary font-PJSbold">{"$"}</p>
          <p className="p-4 text-primary font-PJSbold">{"$"}</p>
        </div>
