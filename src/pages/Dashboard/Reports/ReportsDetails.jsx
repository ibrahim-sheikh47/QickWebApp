...
import { paymentDetails, paymentRecurDetails } from "../../../constants/reportsIndex";
        ...
        <div>
            ...
            {booking && (
                <div className="text-sm text-primary font-PJSbold mt-5">
                    <p><span>{booking.day} , </span><span>{booking.date}</span></p>
                </div>
            )}
            <div className="flex items-center justify-between">
                <p className="mt-2 font-PJSbold text-primary text-sm w-[256px]">Recurring booking linked with Tigers T56(Admin: Angelina Marcus ID45)</p>
            ...
            <div className="h-[1px]  bg-secondaryThirty my-4"></div>
            <p className="font-PJSregular text-sm text-secondary italic">Activity Log: This booking was added by Ali Lal Din on May 4th, 2023
                at 2:56 pm.</p>
...
const RecurringBookingModal = ({ isOpen, onClose, booking }) => (
    <AppModal modalopen={isOpen} onClose={onClose} height="440px" width="495px">
        <div>
            ...
            <div className="flex items-center justify-between">
                <p className="mt-2 font-PJSbold text-primary text-sm w-[256px]">Recurring booking linked with Ashton Brown (ID99)</p>
                <div className="bg-secondaryTen p-2 px-6 rounded-full font-PJSmedium text-sm">
                    <p>Chat</p>
                </div>
            </div>
...
const LeagueSemiFinalsModal = ({ isOpen, onClose, booking }) => (
    <AppModal modalopen={isOpen} onClose={onClose} height="400px" width="495px">
        <div>
            ...
            <p className="mt-2 font-PJSbold text-primary text-sm ">League: Semi-Finals: Rockets vs Orlandians</p>
            ...
            <div className="flex mt-2 items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                        <p className="font-PJSmedium text-secondary text-xs">Booking ID</p>
                        <p className="font-PJSmedium text-sm">NA-3344 <span className="text-xs text-secondary">(not app related)</span></p>
                    </div>
                </div>
                <div className="bg-secondaryTen p-2 px-6 rounded-full font-PJSmedium text-sm">
                    <p>Copy</p>
...
const NewBookingSalesModal = ({ isOpen, onClose, booking }) => (
    <AppModal modalopen={isOpen} onClose={onClose} height="100vh" width="560px" customStyles={{ modal: { overflowY: 'auto' } }}>
        <div>
            ...
            <div className="flex items-center justify-between">
                <p className="mt-2 font-PJSbold text-primary text-sm w-[256px]">New Booking: Ryan Pineda ID25</p>
                <div className="bg-secondaryTen p-2 px-6 rounded-full font-PJSmedium text-sm">
                    <p>Chat</p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-3 mt-3">
                ...
                <div className="flex flex-col gap-1">
                    <p className="font-PJSmedium text-secondary text-xs">Booking Date</p>
                    {booking && (
                        <p className="font-PJSmedium text-sm"><span>{booking.day} , </span><span>{booking.date}</span></p>
                    )}
            ...
            <div className="flex items-center gap-3 mt-3">
                ...
                <div className="flex flex-col gap-1">
                    <p className="font-PJSmedium text-secondary text-xs">Payment Date</p>
                    <p className="font-PJSmedium text-sm">Mon, Jan 31st, 2024, 8:15pm <span className="text-secondary">  (Mastercard ****7789)</span></p>
                </div>
            </div>
            ...
            <div className="flex items-center gap-3 mt-3">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    {booking && (
                        <p className="font-PJSmedium text-sm"><span>{booking.field} , </span><span>{booking.time}</span></p>
                    )}
            ...
            <div>
                <p className="text-xl font-PJSbold text-primary">Payment Details
                    <span className="text-xs text-secondary font-PJSmedium ml-1">(Coupon Applied: VRX56H 20% off)</span></p>
                <div className="grid grid-cols-4 font-PJSregular text-sm text-secondary border rounded-xl mt-5">
                    ...
                    <p className="text-left border-r border-b p-1 px-2">Transaction ID</p>
                    ...
                    {paymentDetails.map((detail, index) => (
                        <React.Fragment key={index}>
                            <p className="text-left text-primary border-r border-b p-2 text-sm whitespace-nowrap">{detail.user}</p>
                            <p className="text-left text-primary border-r border-b p-2 text-sm ">{detail.transactionId}</p>
                            <p className="text-left text-primary border-r border-b p-2  text-sm">{detail.salesTax}</p>
                            <p className="text-left text-primary border-b p-2 text-sm">{detail.playerTotal}
                                <span className="text-secondary text-[10px]">{detail.credit}</span></p>
                        </React.Fragment>
                    ))}
    ...
    return (
        <AppModal modalopen={isOpen} onClose={onClose} height="100vh" width="560px" customStyles={{ modal: { overflowY: 'auto' } }}>
            <div>
                ...
                <div className="flex items-center justify-between">
                    <p className="mt-2 font-PJSbold text-primary text-sm w-[256px]">Recurring Booking: Ryan Pineda ID25</p>
                    <div className="bg-secondaryTen p-2 px-6 rounded-full font-PJSmedium text-sm">
                        <p>Chat</p>
                    </div>
                </div>
                ...
                <div>
                    <div className="flex items-center">
                        ...
                        {paymentFailed && (
                            <span className="text-xs text-redbutton font-PJSbold ml-1"><span>(</span>Payment Failed <span>)</span></span>
                        )}
                    </div>
                    <div className="grid grid-cols-4 font-PJSregular text-sm text-secondary border rounded-xl mt-5">
                        <p className="text-left border-r border-b p-1 px-2 ">User</p>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {paymentSuccess ? (
                            ...
                            <p className="p-4 text-redbutton font-PJSbold flex items-center gap-1">Payment Error
                    ...
                    <div className="flex mt-5 gap-4 w-full justify-center font-PJSMedium items-center">
                        <div>
                            {paymentSuccess ? (
                                <button onClick={handleMarkAsUnpaid} className="w-[250px] transition duration-300 ease-in-out transform hover:scale-105 h-[54px] text-[14px] rounded-full bg-secondaryTen font-PJSmedium justify-center items-center">
                                    Mark As Unpaid
                                </button>
                            ) : (
                                <button className="w-[250px] transition duration-300 ease-in-out transform hover:scale-105 h-[54px] text-[14px] rounded-full bg-secondaryTen font-PJSmedium justify-center items-center" onClick={handleMarkAsPaid}>
...
export { NewBookingModal, LeagueSemiFinalsModal, RecurringBookingModal, PickupFreePlayModal, AcademyModal, NewBookingSalesModal, RecurringBookingSalesModal }