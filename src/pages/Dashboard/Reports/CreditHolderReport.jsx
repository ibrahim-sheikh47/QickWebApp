    ...
    <>
      ...
      <div className="bg-white rounded-lg mt-5 p-2">
        <div className="flex items-center justify-between p-5">
          ...
          <div className="flex items-center gap-3">
            ...
            <div
              className="border-2 border-secondaryThirty bg-transparent w-[165px] text-center justify-center flex h-[42px] rounded-full"
        ...
        <div className="cursor-pointer my-10">
          {holderDetails.map((item, index) => (
            <div key={item.id} onClick={() => handleRowClick(item)}>
              <div
                className={`grid grid-cols-5 items-center gap-4 mx-3 text-sm font-PJSmedium mt-4`}
              >
      ...
      >
        <div className="mt-0">
          ...
          <button className="w-full mt-10 transition duration-300 ease-in-out transform hover:scale-105 h-[40px] text-[14px] rounded-full bg-lime font-PJSmedium justify-center items-center">
            Apply
          </button>
        </div>
      </AppModal>
