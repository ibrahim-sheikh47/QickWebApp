...
const UsersReport = () => {
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-lg mt-5 p-2">
                <div className="flex items-center justify-between p-5">
                    <div className="flex items-center gap-4">
                        ...
                        <p className="text-2xl font-PJSbold text-primary">Users
                            <span className="text-secondary font-PJSregular text-sm ml-1">(7)</span>
                        </p>
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        <div className="border-2 border-secondaryThirty bg-transparent w-[185px] text-center justify-center flex h-[42px] rounded-full cursor-pointer" onClick={openFieldModal}>
                            <p className="my-auto flex items-center text-sm gap-2 text-primary font-PJSmedium"> Most Cancellations
                ...
                <div className="cursor-pointer my-10">
                    {usersDetails.map((item, index) => (
                        <div key={item.id} onClick={() => handleRowClick(item.client)}>
                            <div className={`grid grid-cols-8 items-center gap-4 mx-3 text-sm font-PJSmedium mt-4`}>
            ...
            <AppModal onClose={closeModal} modalopen={modalOpen} height="620px" width="495px">
                <div>
                    ...
                    <div className="flex mt-10 gap-4 w-full justify-center font-PJSMedium items-center">
                        ...
                        <button
                            className="w-full  transition duration-300 ease-in-out transform hover:scale-105 h-[54px] text-[14px] rounded-full bg-redbutton text-white font-PJSmedium justify-center items-center "
                        >
                            Block User
                        </button>
            ...
            <AppModal
                ...
                <div className="mt-0">
                    ...
                    <div className="font-PJSmedium text-sm flex flex-col gap-2">
                        <div className="flex items-center justify-between cursor-pointer" onClick={() => handleOptionSelect('Most Cancellations')}>
                            <p className="underline">Most Cancellations</p>
                            {selectedOption === 'Most Cancellations' && <img src={CheckCircle} className="w-5" alt="Check" />}
                        </div>
                        <div className="flex items-center justify-between cursor-pointer" onClick={() => handleOptionSelect('Most No-Shows')}>
                            <p>Most No-Shows</p>
                            {selectedOption === 'Most No-Shows' && <img src={CheckCircle} className="w-5" alt="Check" />}
                        </div>
                        <div className="flex items-center justify-between cursor-pointer" onClick={() => handleOptionSelect('Most Visits')}>
                            <p>Most Visits</p>
                            {selectedOption === 'Most Visits' && <img src={CheckCircle} className="w-5" alt="Check" />}
                        </div>
                        <div className="flex items-center justify-between cursor-pointer" onClick={() => handleOptionSelect('Most Revenue Generated')}>
                            <p>Most Revenue Generated</p>
                            {selectedOption === 'Most Revenue Generated' && <img src={CheckCircle} className="w-5" alt="Check" />}
                        </div>
                        <div className="flex items-center justify-between cursor-pointer" onClick={() => handleOptionSelect('First Visit')}>
                            <p>First Visit</p>
                            {selectedOption === 'First Visit' && <img src={CheckCircle} className="w-5" alt="Check" />}
                        </div>
                        <div className="flex items-center justify-between cursor-pointer" onClick={() => handleOptionSelect('Last Visit')}>
                            <p>Last Visit</p>
                            {selectedOption === 'Last Visit' && <img src={CheckCircle} className="w-5" alt="Check" />}
                        </div>
                    </div>
                    <button
