...
const SplashScreen = () => {
  return (
    <div className="splash-screen relative h-screen items-center justify-center">
      <img className="blur-md w-full h-full object-cover" src={bgImage} alt="" />

      <img className="absolute top-[45%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60" src={logo} alt="" />
